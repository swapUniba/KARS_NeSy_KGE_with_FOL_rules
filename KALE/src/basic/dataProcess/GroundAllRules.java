...
//			Integer iSndRelation = LstRuleTypeII.get(iFstRelation);		
	...
	public static void main(String[] args) throws Exception {
		...
		*/
		...
		String fnRelationIDMap = "datasets\\x\\relationid.txt";
		String fnRules = "datasets\\x\\r.r";
		String fnTrainingTriples = "datasets\\x\\train.txt";
		String fnOutput = "datasets\\x\\groundings.txt";
